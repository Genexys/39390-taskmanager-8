...
const createTaskCards = function (countTask) {
  boardTasks.insertAdjacentHTML(`beforeend`, getCardElement());
...
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`All`, 2));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`OVERDUE`, 3));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`TODAY`, 5));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`FAVORITES`, 15));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`REPEATING`, 34));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`TAGS`, 0));
filterContainer.insertAdjacentHTML(`beforeend`, getFilterElement(`ARCHIVE`, 65));
